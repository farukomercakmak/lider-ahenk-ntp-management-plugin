package tr.org.liderahenk.ntp.management.commands;
...
public class NtpManagementCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(NtpManagementCommand.class);
